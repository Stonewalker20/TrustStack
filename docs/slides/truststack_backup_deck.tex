...
\begin{frame}{4. Methods and System Architecture}
  \slidelead{The system follows a simple five-step pipeline so users can see where trust is gained or lost, including a reproducible preloaded-source path for live demos.}
